  ...
  app.patch("/api/tasks/:id", async (req, res) => {
    try {
      ...
      const updateTaskSchema = z.object({
        ...
        agencyId: z.preprocess(v => v === "" ? null : v, z.union([z.string(), z.null()]).optional()),
        accountId: z.preprocess(v => v === "" ? null : v, z.union([z.string(), z.null()]).optional()),
        projectId: z.preprocess(v => v === "" ? null : v, z.union([z.string(), z.null()]).optional()),
        assignedToUserId: z.preprocess(v => v === "" ? null : v, z.union([z.string(), z.null()]).optional()),
