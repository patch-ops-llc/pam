...
const searchableRoutes = [
  ...
  { label: "Time Logs", path: "/time-log-audit", group: "Delivery" },
  { label: "Capacity", path: "/capacity", group: "Delivery" },
  { label: "UAT Sessions", path: "/uat", group: "Experiments" },
  { label: "Proposals", path: "/proposals", group: "Experiments" },
  { label: "Knowledge Base", path: "/knowledge-base", group: "Experiments" },
  { label: "Guidance Settings", path: "/guidance-settings", group: "Experiments" },
